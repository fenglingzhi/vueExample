...
<template>
	<div class="radio_list">
		<div class="radio_item ratain-border-bottom" v-for="item in options" v-tap="{ methods : chooseNode , item:item}">
...
<script>
	export default{
		...
		methods:{
			chooseNode(params){
				this.curValue = params.item[this.defaultProps.value]
				this.$emit('chooseNode',params.item)
			}
		},
		mounted(){
